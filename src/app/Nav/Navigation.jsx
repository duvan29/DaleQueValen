...
export default function Navigation() {
  ...
  return (
    ...
    <div className={`${pathname=='/' ? 'pr-[40px] pl-[40px] absolute left-0 right-0':'fixed top-0 left-0 right-0 z-50 bg-white-50 backdrop-blur-sm px-[45px]'} `}>
      <header className="flex items-center justify-between">
        <Link href="/" className={`${pathname=='/' ? 'w-[370px] ml-[45px]':'w-[185px]'} h-auto`}>
