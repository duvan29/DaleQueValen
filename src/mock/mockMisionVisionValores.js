...
const mision = [
  ...
  },
  {
    ...
    title: "Valores",
    description:
      "La fundación se basa en la solidaridad entre las familias, profesionales y donantes para mejorar la vida de los niños y niñas con parálisis cerebral, y así, asegurar la verdadera inclusión con equidad de derechos. Es creativa para adaptarse y buscar soluciones, siempre con esperanza y transmitiendo un mensaje positivo. Busca ser innovadora, alcanzando métodos alternativos de salud. Trabaja con compromiso y busca ofrecer un servicio de calidad, colaborando por un mundo con más amor y empatía.",
    Image: Images.empresa.Valores,
  },
];
