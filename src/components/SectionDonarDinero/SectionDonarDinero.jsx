...
export default function SectionDonarDinero() {
    ...
    return(<section>
        <div className="flex w-full mb-3 lg:my-8 bg-purple-50 rounded-2xl lg:justify-between lg:py-10">
            ...
            <div className="flex-col w-[60%] lg:w-[50%] px-4 py-3 lg:pl-0 lg:pr-20 lg:my-auto">
                ...
                <div className="text-right mt-1 lg:flex lg:items-center lg:justify-start">
                    <h6 className="text-[12px] lg:text-left mb-2 text-purple underline lg:text-[20px] lg:mx-auto cursor-pointer" onClick={toggleText}>{isOpen ? 'Ocultar':'Ver'} Datos Bancarios</h6>
        ...
        <div className={`flex-col lg:flex lg:flex-row overflow-hidden transition-max-height duration-500 ease-in-out ${isOpen ? 'max-h-[500px]':'max-h-0'}`}>
