...
const CardProyectCarousel = ({title, description, image, id}) => {
  return (
    <div className='flex md:h-[450px] ms:h-[190px] ms:flex-row-reverse lg:flex-row'> 
      {/* Lado izquierdo */}
      <div className='md:w-[50%] ms:w-[70%] h-full flex flex-col justify-center relative'>
      ...
      <div className='md:w-[50%] ms:w-[120px] md:h-[450px] ms:h-[190px] md:relative ms:mr-[15px] lg:mr-[0px]'>
        <Image
          key={id}
          id={id}
          src={image}
