...
export default function CardDonarSmall({
  ...
  return (
    <div className={`md:w-full lg:w-[33%] ${flexGrow}`}>
      <div
        className={` md:w-full lg:flex-col md:mb-3 md:my-8 bg-purple-30 rounded-2xl lg:justify-between lg:py-10 lg:px-10 ${flexDirection} lg:h-full lg:m-0 `}
      ...
      >
        ...
        />
        <div
          className={`flex flex-col ms:justify-between md:items-center md:justify-center md:pr-20 md:py-4 md:w-full md:w-[50%] lg:w-full lg:m-0 px-4 py-3 md:py-8 lg:py-4 md:pr-16 md:pl-12 lg:p-0 lg:h-[60%] lg:justify-between lg:mb-4`}
        >
