...
const CardReview = ({ name, profession, testimonio }) => {
  return (
    <div className="border-yellow border-[6px] ms:min-h-[100px] ms:mx-[15px] lg:mx-[0px] lg:w-[360px] ms:w-full ms:p-[25px] lg:h-[480px] relative flex justify-center items-center mb-10">
