...
const CardReview = ({ name, profession, testimonio }) => {
  return (
    <div className="border-yellow border-[6px] ms:min-h-[100px] lg:w-[340px] ms:w-full ms:px-[25px] ms:py-[15px] lg:h-[480px] relative flex justify-center items-center lg:mx-[100px]">
      <div className="lg:w-[300px] lg:h-[420px] ms:h-full ms:w-full relative lg:p-10 ms:p-4 bg-yellow-50">
        <h5 className="relative z-10 lg:h-[300px] ms:text-[12px] md:text-[15px]  overflow-hidden mb-[5px]">
          {testimonio}
        </h5>
