      ...
      <div className='flex ms:mb-[12px] md:mb-[40px]'>
        ...
        <div className='md:flex md:justify-end md:w-[50%] ms:hidden'>
          <Link href='/sumate' className="w-[275px]">
              <button className='bg-orange-20 w-full h-16 px-4 py-3 hover:bg-orange transition-all duration-500 ease-in-out flex items-center justify-center border-2 border-orange text-gray rounded-xl'>
