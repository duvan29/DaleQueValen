...
export default function ContainerTiposDonar({ tiposDeDonar }) {
  ...
  const width40 = 'w-[100%]';
  const flexGrow1 = `grow md:grow-1`;
  ...
  return (
    <div className="flex flex-wrap items-stretch justify-between mt-4 gap-4 md:gap-0 md:flex-nowrap md:flex-col md:justify-evenly lg:flex-row lg:gap-8 mb-8 lg:mb-20">
      {tiposDeDonar
