...
const ContainerReviews = () => {
  return (
    <div className="pt-[60px] pb-[60px]">
      <h1 className="md:text-black  md:text-[30px] md:text-left ms:mb-[12px] md:mb-[40px]  ms:text-center ms:text-black ms:text-[14px]">
        TESTIMONIOS
      </h1>
      <div className="lg:-ml-[140px] lg:-mr-[140px] ms:-ml-[15px] ms:-mr-[15px]">
        <Carousel>
          ...
          />
          <CardReview
            testimonio="Como terapeuta ocupacional, me siento muy afortunada de contar con el respaldo de la fundación Dale que Valen. Gracias a ellos, he podido conocer medicina alternativa que me ha permitido actualizar mis conocimientos y habilidades para trabajar con los niños."
            name="Mariana"
