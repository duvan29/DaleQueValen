...
export default function TimelineItem({
  ...
  return (
    <div className="flex flex-col items-center  relative">
      ...
      <div
        className={`flex w-full justify-between pt-20 mt-5 md:mb-16 ms:mb-[15px] ${
          text1 == "" ? "hidden" : ""
        }`}
      >
        {/* Cuadro de imagen 1 */}
        ...
        {/* Cuadro de texto 1 */}
        <div className="w-1/2 pl-4 flex justify-center">
          <div className="max-w-[470px] lg:max-h-[280px] md:max-h-[310px] md:text-[20px] ms:text-[10px] border-2 rounded-3xl md:border-blue-50 ms:border-none md:px-8 ms:px-0 flex items-center">
            {text1}
          </div>
        </div>
      </div>
      ...
      >
        {/* Cuadro de texto 2 */}
        <div className="w-1/2 pl-4 flex justify-center">
          <div className="max-w-[470px] max-h-[280px] md:text-[20px] ms:text-[10px] border-2 rounded-3xl mr-4 md:border-blue-50 ms:border-none md:px-8 ms:px-0 flex items-center">
            {text2}
          </div>
        </div>
        {/* Cuadro de imagen 2 */}
