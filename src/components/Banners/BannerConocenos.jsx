...
const BannerConocenos = () => {
  return (
    <div>
      <h1 className="md:text-blue md:mb-[40px] md:text-[30px] md:text-left ms:mb-[12px] ms:text-center ms:text-black ms:text-[14px]">QUIENES SOMOS</h1>
      ...
      <div className='w-[70%] flex flex-col justify-start mr-[25px] ms:w-[100%] md:text-left'>
        <h4 className="mb-[20px] ms:mb-[10px] ms:text-[10px] md:text-[20px]">
