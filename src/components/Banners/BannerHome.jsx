const BannerHome = () => {
  return (
    <div className="lg:h-[745px] lg:block ms:flex ms:flex-col ms:items-center ms:justify-center ms:w-full ">
      ...
      <div
        className="w-full  md:w-full lg:w-[570px] lg:relative lg:h-[328px] lg:bottom-[403px]  bg-white-50 bg-opacity-80 border-none rounded-md border p-4 md:p-12 mb-4 md:mb-12 xl:mb-100 ms:shadow-none lg:shadow-lg "
        style={{
          maxWidth: "1200px",
        }}
      >
