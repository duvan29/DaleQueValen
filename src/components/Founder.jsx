    ...
    <>
      ...
      <div className="flex justify-around items-center flex-row lg:pr-[300px] lg:pl-[300px]">
        ...
        <div className="p-4 md:text-center flex flex-col md:justify-center ms:text-left md:items-center">
          ...
          Arantxa es una experta en marketing digital con una sólida formación académica y experiencia laboral en el campo. Su mayor logro es la fundación y dirección de "Dale que Valen", una organización sin fines de lucro en Tucumán que busca brindar terapias alternativas a niños con parálisis cerebral. Esta iniciativa surgió de su propia experiencia, ya que su hijo Valentino tiene parálisis cerebral. La fundación busca mejorar la calidad de vida de estos niños, ofreciéndoles terapias y apoyo especializado. Arantxa es una líder comprometida que utiliza su creatividad y solidaridad para transformar vidas.
          </h4>
        </div>
      </div>
    </>
